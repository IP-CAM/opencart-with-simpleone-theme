...
class ModelVendorLtsOrder extends Model {
	...
	public function getOrders($data = array()) {
		$sql = "SELECT o.order_id, CONCAT(o.firstname, ' ', o.lastname) AS customer, CONCAT(lvop.firstname, ' ', lvop.lastname) AS vname, (SELECT os.name FROM " . DB_PREFIX . "order_status os WHERE os.order_status_id = o.order_status_id AND os.language_id = '" . (int)$this->config->get('config_language_id') . "') AS order_status, o.shipping_code, o.total, o.currency_code, o.currency_value, o.date_added, o.date_modified FROM `" . DB_PREFIX . "order` o RIGHT JOIN ". DB_PREFIX ."lts_vendor_order_product lvop  ON(lvop.order_id = o.order_id) ";
	...
	public function getOrderProducts($order_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "lts_vendor_order_product WHERE order_id = '" . (int)$order_id . "'");
	...
	public function getVendorName($product_id) {
		...
		$query = $this->db->query("SELECT vendor_id FROM ". DB_PREFIX ."lts_vendor_order_product WHERE product_id='". (int)$product_id ."' ");

		$vendor_id = $query->row;

		$query = $this->db->query("SELECT CONCAT(firstname, ' ', lastname) AS vname FROM ". DB_PREFIX ."lts_vendor WHERE vendor_id='". (int)$vendor_id ."'");
