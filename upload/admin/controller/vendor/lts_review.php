    ...
    protected function getList() {
        ...
        foreach ($results as $value) {
            ...
            $data['reviews'][] = array(
                ...
                'approve' => $this->url->link('vendor/lts_review/approve', 'user_token=' . $this->session->data['user_token'] . '&review_id=' . $value['review_id'], true),
                'disapprove' => $this->url->link('vendor/lts_review/disapprove', 'user_token=' . $this->session->data['user_token'] . '&review_id=' . $value['review_id'], true),
                'view' => $this->url->link('catalog/review/edit', 'user_token=' . $this->session->data['user_token'] . '&review_id=' . $value['review_id'], true)
            );
        }
