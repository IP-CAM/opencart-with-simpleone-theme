...
class ControllerVendorLtsProduct extends Controller {
    ...
    protected function getList() {
        ...
        foreach ($results as $result) {
            ...
            $vendor_name = $this->model_vendor_lts_vendor->getVendorName($result['vendor_id']);
            ...
            $data['products'][] = array(
                ...
                'status'        => $result['status'] ? $this->language->get('text_approve') : $this->language->get('text_pending'),
        ...
        $data['sort_vendor'] = $this->url->link('vendor/lts_product', 'user_token=' . $this->session->data['user_token'] . '&sort=v.vname' . $url, true);
