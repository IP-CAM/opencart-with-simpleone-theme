<?php
class ModelVendorLtsDownload extends Model {
	public function addDownload($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "lts_vendor_download SET download_id = '". (int)$download_id ."', vendor_id = '" . (int)$this->customer->getId() . "'");
	...
	public function deleteDownload($download_id) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "lts_vendor_download WHERE download_id = '" . (int)$download_id . "' AND vendor_id = '".  (int)$this->customer->getId() ."'");
	...
	public function getDownloads($data = array()) {
		...
		$sql = "SELECT * FROM " . DB_PREFIX . "download d LEFT JOIN " . DB_PREFIX . "download_description dd ON (d.download_id = dd.download_id)  RIGHT JOIN `" . DB_PREFIX . "lts_vendor_download` lvd ON (d.download_id = lvd.download_id) WHERE dd.language_id = '" . (int)$this->config->get('config_language_id') . "' AND lvd.vendor_id='". (int)$this->customer->getId() ."'";
	...
	public function getTotalDownloads() {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "lts_vendor_download WHERE vendor_id='". (int)$this->customer->getId() ."'");
