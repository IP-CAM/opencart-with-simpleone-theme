<?php
class ModelVendorLtsCoupon extends Model {
	public function addCoupon($data) {
		...
		$this->db->query("INSERT INTO ". DB_PREFIX ."lts_vendor_coupon SET coupon_id='". (int)$coupon_id ."', vendor_id='". (int)$this->customer->getId() ."', code='". $this->db->escape($data['code']) ."'");
	...
	public function editCoupon($coupon_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "lts_vendor_coupon SET code = '" . $this->db->escape($data['code']) . "' WHERE coupon_id = '" . (int)$coupon_id . "' AND vendor_id='". (int)$this->customer->getId() ."'");
	...
	public function deleteCoupon($coupon_id) {
		$this->db->query("DELETE FROM " . DB_PREFIX . "lts_vendor_coupon WHERE coupon_id = '" . (int)$coupon_id . "' AND vendor_id='". (int)$this->customer->getID() ."'");
	...
	public function getCoupons($data = array()) {
		$sql = "SELECT * FROM " . DB_PREFIX . "coupon c RIGHT JOIN ". DB_PREFIX ."lts_vendor_coupon lvc ON(c.coupon_id = lvc.vendor_id) ";
	...
	public function getTotalCoupons() {
		...
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "lts_vendor_coupon WHERE vendor_id='". (int)$this->customer->getId() ."'");
