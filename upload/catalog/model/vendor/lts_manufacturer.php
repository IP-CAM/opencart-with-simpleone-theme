<?php
class ModelVendorLtsManufacturer extends Model {
	public function addManufacturer($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "lts_vendor_manufacturer SET manufacturer_id = '" . (int)$manufacturer_id . "', vendor_id = '" . (int)$this->customer->getId() . "'");
	...
	public function deleteManufacturer($manufacturer_id) {
		...
		$this->db->query("DELETE FROM `" . DB_PREFIX . "lts_vendor_manufacturer` WHERE manufacturer_id = '" . (int)$manufacturer_id . "' AND vendor_id = '" . $this->customer->isVendor() . "'");
	...
	public function getManufacturers($data = array()) {
		...
		$sql = "SELECT * FROM " . DB_PREFIX . "lts_vendor_manufacturer lvm LEFT JOIN " . DB_PREFIX . "manufacturer m ON(lvm.manufacturer_id = m.manufacturer_id) WHERE lvm.vendor_id = '" . $this->customer->getId() . "'";
	...
	public function getTotalManufacturers() {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "lts_vendor_manufacturer WHERE vendor_id ='" . (int)$this->customer->getId() . "'");
