...
class ModelVendorLtsOption extends Model {
	public function addOption($data) {
		...
		$this->db->query("INSERT INTO `" . DB_PREFIX . "lts_vendor_option` SET option_id = '" . (int)$option_id . "', vendor_id = '" . (int)$this->customer->getId() . "'");
	...
	public function deleteOption($option_id) {
		...
		$this->db->query("DELETE FROM `" . DB_PREFIX . "lts_vendor_option` WHERE option_id = '" . (int)$option_id . "' AND vendor_id = '" . (int)$this->customer->getId() . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "option_description WHERE option_id = '" . (int)$option_id . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "option_value WHERE option_id = '" . (int)$option_id . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "option_value_description WHERE option_id = '" . (int)$option_id . "'");
	}
	...
	public function getOptions($data = array()) {
		$sql = "SELECT * FROM `" . DB_PREFIX . "lts_vendor_option` lvo LEFT JOIN " . DB_PREFIX . "option o ON (lvo.option_id = o.option_id) LEFT JOIN " . DB_PREFIX . "option_description od ON(lvo.option_id = od.option_id) WHERE od.language_id = '" . (int)$this->config->get('config_language_id') . "' AND lvo.vendor_id = '" . (int)$this->customer->getId() . "'";
	...
	public function getTotalOptions() {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM `" . DB_PREFIX . "lts_vendor_option` WHERE  vendor_id='". (int)$this->customer->getId() ."'");
