<?php
class ModelVendorLtsFilter extends Model {
	public function addFilter($data) {
		...
		$this->db->query("INSERT INTO `" . DB_PREFIX . "lts_vendor_filter_group` SET filter_group_id = '" . (int)$filter_group_id . "', vendor_id = '" . (int)$this->customer->getId() . "'");
	...
	public function getFilterGroups($data = array()) {
		...
		$sql = "SELECT * FROM `" . DB_PREFIX . "lts_vendor_filter_group` lvfg LEFT JOIN " . DB_PREFIX . "filter_group fg ON(lvfg.filter_group_id = fg.filter_group_id) LEFT JOIN " . DB_PREFIX . "filter_group_description fgd ON(lvfg.filter_group_id = fgd.filter_group_id) WHERE fgd.language_id = '" . (int)$this->config->get('config_language_id') . "' AND vendor_id = '" . $this->customer->getId() . "' ";
	...
	public function getTotalFilterGroups() {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM `" . DB_PREFIX . "lts_vendor_filter_group` WHERE vendor_id='". (int)$this->customer->getId() ."'");
