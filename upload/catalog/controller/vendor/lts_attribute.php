...
class ControllerVendorLtsAttribute extends Controller {
  ...
  public function add() {
    ...
    if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
      $this->model_vendor_lts_attribute->addAttribute($this->request->post);
      ...
      $this->response->redirect($this->url->link('vendor/lts_attribute', $url));
    }
  ...
  public function edit() {
    ...
    if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
      $this->model_vendor_lts_attribute->editAttribute($this->request->get['attribute_id'], $this->request->post);
  ...
  public function delete() {
    ...
    if (isset($this->request->post['selected']) && $this->validateDelete()) {
      foreach ($this->request->post['selected'] as $attribute_id) {
        $this->model_vendor_lts_attribute->deleteAttribute($attribute_id);
      }
  ...
  protected function getList() {
    ...
    $data['breadcrumbs'][] = array(
        ...
        'href' => $this->url->link('vendor/lts_attribute', $url)
    );

    $data['add'] = $this->url->link('vendor/lts_attribute/add');
    $data['delete'] = $this->url->link('vendor/lts_attribute/delete');
    ...
    $attribute_total = $this->model_vendor_lts_attribute->getTotalAttributes();

    $results = $this->model_vendor_lts_attribute->getAttributes($filter_data);
    ...
    foreach ($results as $result) {
      $data['attributes'][] = array(
          ...
          'edit' => $this->url->link('vendor/lts_attribute/edit', '&attribute_id=' . $result['attribute_id'] . $url, true)
      );
    }
    ...
    $data['sort_name'] = $this->url->link('vendor/lts_attribute', '&sort=ad.name' . $url, true);
    $data['sort_attribute_group'] = $this->url->link('vendor/lts_attribute', '&sort=attribute_group' . $url, true);
    $data['sort_sort_order'] = $this->url->link('vendor/lts_attribute', '&sort=a.sort_order' . $url, true);
    ...
    $pagination->url = $this->url->link('vendor/lts_attribute', '&page={page}', true);
  ...
  protected function getForm() {
    ...
    $data['breadcrumbs'][] = array(
        'text' => $this->language->get('heading_title'),
        'href' => $this->url->link('vendor/lts_attribute', $url, true)
    );

    if (!isset($this->request->get['attribute_id'])) {
      $data['action'] = $this->url->link('vendor/lts_attribute/add', $url, true);
    } else {
      $data['action'] = $this->url->link('vendor/lts_attribute/edit', '&attribute_id=' . $this->request->get['attribute_id'] . $url, true);
    }

    $data['cancel'] = $this->url->link('vendor/lts_attribute', $url, true);

    if (isset($this->request->get['attribute_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
      $attribute_info = $this->model_vendor_lts_attribute->getAttribute($this->request->get['attribute_id']);
    }
    ...
    if (isset($this->request->post['attribute_description'])) {
      ...
      $data['attribute_description'] = $this->model_vendor_lts_attribute->getAttributeDescriptions($this->request->get['attribute_id']);
    } else {
    ...
    $data['attribute_groups'] = $this->model_vendor_lts_attribute_group->getAttributeGroups();
  ...
  protected function validateDelete() {
    ...
    foreach ($this->request->post['selected'] as $attribute_id) {
      $product_total = $this->model_vendor_lts_product->getTotalProductsByAttributeId($attribute_id);
