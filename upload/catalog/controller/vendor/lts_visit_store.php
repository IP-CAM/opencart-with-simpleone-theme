...
class ControllerVendorLtsVisitStore extends Controller {
  ...
  public function index() {
    ...
    $vendor_product_info = $this->model_vendor_lts_product->getProducts();
    ...
    $this->response->setOutput($this->load->view('vendor/lts_visit_store', $data));
  }
