...
class ControllerVendorLtsFileManager extends Controller {
  ...
  public function index() {
    ...
    foreach ($images as $image) {
      ...
      if (is_dir($image)) {
        ...
        $data['images'][] = array(
            ...
            'href' => $this->url->link('vendor/lts_filemanager', '&directory=' . urlencode(utf8_substr($image, utf8_strlen(DIR_IMAGE . 'catalog/'))) . $url, true)
        );
    ...
    $data['parent'] = $this->url->link('vendor/lts_filemanager');
    ...
    $data['refresh'] = $this->url->link('vendor/lts_filemanager');
    ...
    $pagination->limit = 16;
    $pagination->url = $this->url->link('vendor/lts_filemanager', '&page={page}', true);

    $data['pagination'] = $pagination->render();

    $this->response->setOutput($this->load->view('vendor/lts_filemanager', $data));
  }
  ...
  public function folder() {
    ...
    if (!$this->user->hasPermission('modify', 'vendor/lts_filemanager')) {
