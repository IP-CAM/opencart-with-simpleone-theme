...
class ControllerVendorLtsCategory extends Controller {
  ...
  public function add() {
    ...
    if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
      $this->model_vendor_lts_category->addCategory($this->request->post);
      ...
      $this->response->redirect($this->url->link('vendor/lts_category'));
    }
  ...
  public function delete() {
    ...
    if (isset($this->request->post['selected'])) {
      foreach ($this->request->post['selected'] as $category_id) {
        $this->model_vendor_lts_category->deleteCategory($category_id);
      }
      ...
      $this->response->redirect($this->url->link('vendor/lts_category', $url, true));
    }
  ...
  public function repair() {
    ...
    if ($this->validateRepair()) {
      $this->model_vendor_lts_category->repairCategories();
  ...
  protected function getList() {
    ...
    $data['breadcrumbs'][] = array(
        ...
        'href' => $this->url->link('vendor/lts_category')
    );

    $data['add'] = $this->url->link('vendor/lts_category/add');
    $data['delete'] = $this->url->link('vendor/lts_category/delete');
    $data['repair'] = $this->url->link('vendor/lts_category/repair');
    ...
    $category_total = $this->model_vendor_lts_category->getTotalCategories();
    ...
    foreach ($results as $result) {
      $data['categories'][] = array(
          ...
          'name' => $result['name'],
          'status' => $result['status'] ? $this->language->get('text_approved') : $this->language->get('text_pending'),
          'sort_order' => $result['sort_order'],
          'edit' => $this->url->link('vendor/lts_category/edit', '&category_id=' . $result['category_id']),
      );
    }
    ...
    $data['sort_name'] = $this->url->link('vendor/lts_category');
    $data['sort_sort_order'] = $this->url->link('vendor/lts_category');
    ...
    $pagination->url = $this->url->link('vendor/lts_category', '&page={page}');
    ...
    $this->response->setOutput($this->load->view('vendor/lts_category_list', $data));
  }
  ...
  protected function getForm() {
    ...
    if (!isset($this->request->get['category_id'])) {
      $data['action'] = $this->url->link('vendor/lts_category/add');
    } else {
      $data['action'] = $this->url->link('vendor/lts_category/edit', '&category_id=' . $this->request->get['category_id']);
    }

    $data['cancel'] = $this->url->link('vendor/lts_category');
    ...
    $this->response->setOutput($this->load->view('vendor/lts_category_form', $data));
  }
  ...
  protected function validateRepair() {
    if (!$this->vendor->hasPermission('modify', 'vendor/lts_category')) {
